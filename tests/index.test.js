...
const december2018 = new Date("2018-12-31T08:00:00.000Z");
const january2019 = new Date("2019-01-31T08:00:00.000Z");
...
test("Dates with Metadata for December of 2018", () => {
  const expected = [
...
test("Dates with Metadata for January of 2019", () => {
  const expected = [
